# Contributing to plugin-scheduler-template

## Before You Start

Anyone wishing to contribute to the **[PyBossa/plugin-scheduler-template](https://github.com/PyBossa/plugin-scheduler-template)** project 
